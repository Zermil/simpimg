...
set CXXFLAGS=/std:c++17 /EHsc /W4 /WX /Zl /wd4996 /wd4201 /nologo /O2 /DNDEBUG %*
...
cl %CXXFLAGS% %INCLUDES% code\main.cpp /Fo:build\ /Fe:build\opengl_release.exe %LIBS% /link /NODEFAULTLIB:libcmt.lib /SUBSYSTEM:windows /ENTRY:mainCRTStartup
popd